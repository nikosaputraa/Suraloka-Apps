<div class="mt-8 md:mt-8">
    ...
    <div class="relative overflow-x-auto shadow-md sm:rounded-lg bg-white">
                            ...
                            <div class="relative p-4 w-full max-w-md bg-white rounded-lg shadow-lg dark:bg-gray-700">
                                ...
                                <div class="relative">
                                    ...
                                    <div
                                        ...
                                        <h3 class="text-lg font-semibold text-gray-900 dark:text-white">Add New Plant
                                        </h3>
                                        <button type="button"
                                    ...
                                    <!-- Body modal -->
                                    <form action="{{ route('plants-add.store') }}" method="POST" id="addAnimalForm"
                                            ...
                                            <div class="grid gap-4 mb-4 grid-cols-1 p-4">
                                                ...
                                                <div>
                                                    ...
                                                    <input type="text" name="latin_name" id="latin_name"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        placeholder="Masukkan nama latin plant" required="">
                                                </div>
                                                <div>
                                        ...
                                        <div class="form-section hidden" data-section="2">
                                            ...
                                            <div class="grid gap-4 mb-4 grid-cols-1 p-4">
                                                <div>
                                                    ...
                                                    <textarea name="plant_desc" id="plant_desc"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        placeholder="Masukkan deskripsi plant" rows="5"
                                                        required=""></textarea>
                                                </div>
                                                <div>
                                                    ...
                                                    <input type="text" name="plant_habitat" id="plant_habitat"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        placeholder="Masukkan habitat plant" required="">
                                                </div>
                                                <div>
                                        ...
                                        <div class="form-section hidden" data-section="3">
                                            ...
                                            <div class="grid gap-4 mb-4 grid-cols-1 p-4">
                                                <div>
                                                    ...
                                                    <textarea name="plant_klasifikasi" id="plant_klasifikasi"
                                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2 dark:bg-gray-600 dark:border-gray-500 dark:placeholder-gray-400 dark:text-white dark:focus:ring-primary-500 dark:focus:border-primary-500"
                                                        placeholder="Masukkan klasifikasi plant" rows="5"
                                                        required=""></textarea>
                                                </div>
                                                <div>
            ...
            <tbody>
                ...
                <tr
                    ...
                    <td scope="row" class="px-6 py-2 font-medium text-gray-700">
                        {{ $plants->firstItem() + $loop->index }}
                    </td>
                    <td class="flex px-6 py-2 font-medium text-gray-700">
                        @if($plant->plant_image)
                        <img src="{{ asset('storage/' . $plant->plant_image) }}" alt="{{ $plant->plant_name }}"
                            style="max-width: 80%;">
                        @else
                        <p>No Image</p>
                        @endif
        ...
        <div class="p-3">
        {{ $plants->links('tailwind-pagination') }}
        </div>
    </div>
