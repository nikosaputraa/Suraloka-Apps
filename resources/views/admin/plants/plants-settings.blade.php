...
<div class="h-screen flex flex-row flex-wrap">
    ...
    <div class="bg-gray-100 flex-1 mt-16 p-6 md:mt-16">
        <div class="flex flex-col w-full justify-center">
                                ...
                                <div id="crud-modal" tabindex="-1" aria-hidden="true"
                                    ...
                                    <div
                                        ...
                                        <div class="relative">
                                            ...
                                            <!-- Modal body -->
                                            <form action="{{ route('plants-categories.store') }}" method="POST"
                        ...
                        <tr
                            ...
                            <td class="px-6 py-2 font-medium text-gray-700">
                                <div class="flex flex-row justify-start gap-3 items-center">
                                    ...
                                    <div id="edit-modal-{{ $category->id }}" tabindex="-1" aria-hidden="true"
                                        ...
                                        <div
                                            ...
                                            <div class="relative">
                                                ...
                                                <!-- Modal body -->
                                                <form action="{{ route('plants-categories.update', $category->id) }}"
                                    ...
                                    <form action="{{ route('plants-categories.destroy', $category->id) }}"
                                        method="POST">
                                        @csrf
                                        @method('DELETE')
                                        <button type="submit"
            ...
            @include('admin.plants.list-plants')
        </div>
