                        ...
                        <tr>
                            ...
                            <div class="px-6 py-4 w-full flex gap-4 text-center">
                                ...
                                <p class="font-bold text-xl text-center text-black">
                                    Detail Animals {{ $animal->animal_name }}
                                </p>
                    ...
                    <tbody>
                        <div class="px-6 pb-4 grid gap-4 md:grid-cols-2 text-gray-900">
                            ...
                            <div class="flex flex-col gap-4">
                                <p class="text-gray-900 text-lg text-bold"><strong>{{ $animal->animal_name }}</strong>
                                </p>
                                ...
                                <p class="text-gray-900"><strong>Description:</strong> <br>
                                    {{ $animal->animal_desc }}</p>
                                <p class="text-gray-900"><strong>Habitat:</strong> <br>
                                    {{ $animal->animal_habitat }}</p>
                                <p class="text-gray-900"><strong>Origin:</strong> <br>
                                    {{ $animal->animal_origin }}</p>
                                <p class="text-gray-900"><strong>Diet:</strong> <br>
                                    {{ $animal->animal_diet }}</p>
                                <p class="text-gray-900"><strong>Lifespan:</strong> <br>
                                    {{ $animal->animal_lifespan }}</p>
                            </div>
                        </div>
                    </tbody>
                </table>
