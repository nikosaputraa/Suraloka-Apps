        ...
        <div class="relative h-screen overflow-hidden md:h-screen">
            ...
            <div class="z-0 hidden duration-700 ease-in-out" data-carousel-item>
                ...
                <div class="text-white text-[90px] inset-0 absolute flex flex-col items-center justify-center">
                    <p class="text-amber-400 text-[64px] font-baloo-2-bold">{{ $animal->animal_name }} <span>(
                            {{ $animal->latin_name }} )</span></p>
        ...
        <div class="w-full">
            ...
            <div class="flex flex-row justify-between max-w-6xl mx-auto py-[60px]">
                <div class="flex flex-col gap-[50px] w-[708px] lg:w-[600px]">
                    <div>
                        <p class="font-baloo-2-bold text-[32px]">{{ $animal->animal_name }}</p>
                        <p class="font-baloo-2 text-[16px]">{{ $animal->latin_name }}</p>
                    </div>
                    <div class="flex flex-col gap-[32px]">
                        <div class="flex flex-col gap-1">
                            <p class="font-baloo-2-bold text-[20px] text-emerald-800">Deskripsi</p>
                            <p class="font-baloo-2 text-[16px] text-justify">{{ $animal->animal_desc }}</p>
                        </div>
                        <div class="flex flex-col gap-1">
                            <p class="font-baloo-2-bold text-[20px] text-emerald-800">Habitat</p>
                            <p class="font-baloo-2 text-[16px]">{{ $animal->animal_habitat }}</p>
                        </div>
                        <div class="flex flex-col gap-1">
                            <p class="font-baloo-2-bold text-[20px] text-emerald-800">Asal</p>
                            <p class="font-baloo-2 text-[16px]">{{ $animal->animal_origin }}</p>
                        </div>
                        <div class="flex flex-col gap-1">
                            <p class="font-baloo-2-bold text-[20px] text-emerald-800">Makanan</p>
                            <p class="font-baloo-2 text-[16px]">{{ $animal->animal_diet }}</p>
                        </div>
                        <div class="flex flex-col gap-1">
                            <p class="font-baloo-2-bold text-[20px] text-emerald-800">Rentang Umur</p>
                            <p class="font-baloo-2 text-[16px]">{{ $animal->animal_lifespan }}</p>
                        </div>
                    </div>
                </div>
                @endforeach
                <div class="flex flex-col w-[300px] gap-[32px]">
                        ...
                        <form class="w-full">
                            ...
                            <div class="relative w-full">
                                ...
                                <input type="search" id="default-search"
                                    ...
                                    placeholder="Search hewan ..." required />
                                <button type="submit"
                    ...
                    @foreach($relatedAnimals as $animal)
                        <div class="{{ $loop->index >= 2 ? 'hidden' : '' }}">
                            <div class="h-auto max-w-full rounded-lg bg-white shadow shadow-slate-200 px-4 py-4">
                                ...
                                <p class="font-baloo-2 text-14">{{ $animal->animal_desc }}</p>
